...
import { BundlerOptions } from "../data/interfaces";
...
export default async function bundleHTML(inputFile: string, outputFile: string, cssContent: string, jsContent: string, options: BundlerOptions): Promise<void> {
    const fs = require("fs");

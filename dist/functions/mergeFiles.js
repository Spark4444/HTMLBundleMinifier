...
function mergeFiles(fileList, type, htmlPath) {
    ...
    fileList.forEach((item) => {
        if (item.type === "inline") {
            if (type === "CSS") {
                item.content = (0, replaceRelativeCSSPaths_1.replaceRelativeCSSPaths)(htmlPath, htmlPath, item.content);
            }
            ...
            try {
                ...
                if (type === "CSS") {
                    content = (0, replaceRelativeCSSPaths_1.replaceRelativeCSSPaths)(htmlPath, filePath, content);
                }
